...
-   Step 1: Fit the sine-wave to observed isotope concentrations in precipitation, e.g., using the iteratively least squares (IRLS) regression approach. The sine-wave used for fitting has the following form :
...
-   Step 2: Fit the sine-wave to observed isotope concentrations in streamflow, e.g., using IRLS. The sine-wave used for fitting has the following form:
...
for (icatchment in 1:2){
  ...
  traditionalProcedure$phiP[icatchment] <- findPhi(aP = traditionalProcedure$aP[icatchment],
                                                   bP = traditionalProcedure$bP[icatchment])
  traditionalProcedure$phiS[icatchment] <- findPhi(aP = traditionalProcedure$aS[icatchment],
                                                   bP = traditionalProcedure$bS[icatchment])
...
```{r, fig.width=10,fig.height=8, fig.align = 'center', eval = TRUE}
...
instream isotope concentrations. This step is computationally demanding and 
...
Now compare the simulated instream isotope concentrations from the traditional 
