...
ggplot()+
  ...
  geom_line(aes(x = isotopeP[[icatchment]]$date, y = as.numeric(traditionalProcedure$fitSineP[[icatchment]]$fitted.values), color = "cP (fitted sine-wave)")) +
...
Compared results (parameter of the transit time - gamma distribution and the Fyw)
